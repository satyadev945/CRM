...
class CustomerControllerTest {
    ...
    @Test
    void showAllCustomers_shouldReturnCustomerListView() {
    ...
    @Test
    void showFormCreateCustomerBasedOnAnotherOne_shouldReturnAddBasedOnAnotherView() {
        Long customerId = 1L;
        when(customerService.showCustomer(customerId)).thenReturn(testCustomer);
    ...
    @Test
    void showCityAddressSearchForm_shouldReturnCityAddressSearchView() {
    ...
    void processRequestCityAddressSearch_shouldReturnShowListView() {
        when(customerService.findByEnabledTrueAndCityAndAddress(testCustomer.getCity(), testCustomer.getAddress()))
