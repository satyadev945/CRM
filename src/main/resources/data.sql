...
-- WARNING: Default test credentials below should ONLY be used in development environments
-- For production deployments, remove these default users or use environment-specific initialization
-- Configure spring.profiles.active and use data-dev.sql vs data-prod.sql for environment separation
